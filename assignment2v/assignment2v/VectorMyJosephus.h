...
public:
	...
	Person eliminateNext(vector<Person>::iterator temp);
	...
	int getN();
	int getM();
	vector<Person>::iterator getBeginning();
	vector<Person>::iterator getEnd();
	int getPosition(vector<Person>::iterator it);
	void run();
